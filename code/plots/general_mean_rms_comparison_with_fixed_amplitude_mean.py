...
if __name__ == '__main__':
    ...
    ax0.errorbar(noise_means, mf_means_mean, c='g', marker='_', yerr=mf_means_std, label='DP-MF',ls='None')
    ...
    ax1.errorbar(noise_means, mf_stds_mean, c='g', marker='_', yerr=mf_stds_std, label='DP-MF', ls='None')
