...
if __name__ == '__main__':
    ...
    ax0.errorbar(channels, smf_means_mean, c='g', marker='_', yerr=smf_means_std, label='DP-MF',ls='None')
    ...
    ax1.errorbar(channels, smf_stds_mean, c='g', marker='_', yerr=smf_stds_std, label='DP-MF', ls='None')
