...
def correlation_plot(x, y, ax, method):
    ...
    da1 = dsshow(df, ds.Point('x', 'y'), norm='log', aspect='auto', ax=ax, x_range=(-1, 400), y_range=(-150, 400), shade_hook=partial(tf.dynspread, threshold=0.8))
...
if "__main__" == __name__:
    ...
    ax2 = correlation_plot(reference_data, smf_data, ax2, method='S-MF')
    plt.show()
